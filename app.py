...
3) 逻辑清晰：人物台词互动清晰，内容衔接清晰。
4) 实用输出：格式简洁，便于直接进入拍摄拆解。
5) 描述内容：把女主的心理活动合理转化成内心OS台词，搭配可视化表情和动作把人物塑造得更丰满立体。
6) 剧本原则：剧本末尾必须和小说内容一致，严谨续写。
7) 主线定义：剧本只以主角为核心搭建，除去主角以外的场景都视为支线，可删除或者一笔带过。（不能影响到【3）逻辑清晰】）
====================
二、优先级（冲突时按此顺序）
====================
P1. 原著事件与因果完整
